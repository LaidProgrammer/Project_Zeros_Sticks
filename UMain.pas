...
begin
  ...
  Self.Edit1.Text := '0,7';
  Self.Edit3.Text := '3';
  Self.First_Player_Panel.Caption := '¡ÓÚ ÍÓÏ‡Ì‰˚ π1';
  Self.Second_Player_Panel.Caption := '¡ÓÚ ÍÓÏ‡Ì‰˚ π2';
...
begin
  ...
  begin
    ...
    MessageBox(0,'¬˚Ë„‡ÎË ÍÂÒÚËÍË!','œŒ¡≈ƒ¿',0);
    try
  ...
  begin
    ...
    MessageBox(0,'¬˚Ë„‡ÎË ÌÓÎËÍË!','œŒ¡≈ƒ¿',0);
    win_x:=0;
    win_o:=0;
  end;
  Self.Enabled := True;
